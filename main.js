...
//starting bot
console.log("Starting HamsterBot Vision " + package.version +"...")
//load config
...
const loginFB = require("./function/loginfb/login.js");
const modules = {
    loginwithappstate: loginFB,
    checkUpdate: async function () {
        try {
            const { data } = await axios.get("https://raw.githubusercontent.com/HamsterBotV1/b0t/main/package.json");
